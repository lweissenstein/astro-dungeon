...
- **Tilemap-based arena** for structured and engaging levels  
- **Power-ups** with custom pulsating shaders  
- **Local highscore system** to track your best scores  
- **Pause and main menu system** with simple, intuitive controls  
- **Audio integration** with background music and sound effects  
- **Animated astronaut character** with directional sprites for smooth movement  
